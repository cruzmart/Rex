...
public class RexParser extends Parser {
	...
	public static final int
		T__0=1, IF=2, ELIFX=3, ELSE=4, FN=5, LET=6, MUT=7, FOR=8, WHILE=9, LOOP=10, 
		IN=11, RETURN=12, TYPE=13, PRINT=14, INT=15, BOOL=16, CHAR=17, REAL=18, 
		STRING=19, TRUE=20, FALSE=21, AND=22, OR=23, ARROW=24, PIPE=25, ASSIGN=26, 
		EQ=27, NEQ=28, LT=29, GT=30, LTE=31, GTE=32, PLUS=33, MINUS=34, STAR=35, 
		DIV=36, MOD=37, RANGE=38, LPAREN=39, RPAREN=40, LBRACE=41, RBRACE=42, 
		LBRACK=43, RBRACK=44, COMMA=45, SEMI=46, COLON=47, BREAK=48, ID=49, INT_LITERAL=50, 
		REAL_LITERAL=51, STRING_LITERAL=52, CHAR_LITERAL=53, WS=54, LINE_COMMENT=55, 
		BLOCK_COMMENT=56;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'.'", "'if'", "'elifx'", "'else'", "'function'", "'let'", "'mut'", 
			"'for'", "'while'", "'loop'", "'in'", "'return'", "'type'", "'print'", 
			"'Int'", "'Bool'", "'Char'", "'Real'", "'String'", "'true'", "'false'", 
			"'and'", "'or'", "'->'", "'|>'", "'='", "'=='", "'!='", "'<'", "'>'", 
			"'<='", "'>='", "'+'", "'-'", "'*'", "'/'", "'%'", "'..'", "'('", "')'", 
			"'{'", "'}'", "'['", "']'", "','", "';'", "':'", "'break'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "IF", "ELIFX", "ELSE", "FN", "LET", "MUT", "FOR", "WHILE", 
			"LOOP", "IN", "RETURN", "TYPE", "PRINT", "INT", "BOOL", "CHAR", "REAL", 
			"STRING", "TRUE", "FALSE", "AND", "OR", "ARROW", "PIPE", "ASSIGN", "EQ", 
			"NEQ", "LT", "GT", "LTE", "GTE", "PLUS", "MINUS", "STAR", "DIV", "MOD", 
			"RANGE", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"COMMA", "SEMI", "COLON", "BREAK", "ID", "INT_LITERAL", "REAL_LITERAL", 
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17742295154587492L) != 0)) {
				{
				{
				setState(50);
				item();
	...
	public final ReturnStmtContext returnStmt() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17460820177846272L) != 0)) {
				{
				setState(161);
				expr(0);
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17742295154587460L) != 0)) {
				{
				{
				setState(219);
				statement();
	...
	@SuppressWarnings("CheckReturnValue")
	public static class IndexTupleExprContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		public IndexTupleExprContext(ExprContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new IndexTupleExprContext(new ExprContext(_parentctx, _parentState));
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(311);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 16888498605785088L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
